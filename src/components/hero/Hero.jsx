 ...
 <div className="relative w-full h-full flex items-center justify-center">
      <div className="solar-panel-container transform-gpu perspective-1000">
        <div className="solar-panel animate-float">
          ...
          <div className="absolute -bottom-16 left-1/2 transform -translate-x-1/2 w-32 h-4 bg-gradient-to-r from-gray-700 to-gray-800 rounded-lg shadow-lg" />
        </div>
      </div>
    </div>
...
const Hero = () => {
  ...
  return (
    <div className=" relative min-h-screen overflow-hidden bg-gradient-to-br from-slate-900 via-blue-900 to-indigo-900">
      ...
      {/* Hero Content */}
      <div className="relative  z-10 flex flex-col lg:flex-row items-center justify-end lg:justify-between min-h-screen  py-20">
        {/* Left Content */}
        <div className=" max-w-2xl text-center lg:text-left mb-10 lg:mb-0">
          <div className={`transform transition-all duration-1000 ${isLoaded ? 'translate-y-0 opacity-100' : 'translate-y-10 opacity-0'}`}>
            ...
            <div className="grid grid-cols-3 gap-4 max-w-md mx-auto lg:mx-0">
              <div  className="  text-center lg:text-left border solar-panel  border-primaryLighter  duration-200 ease-in hover:scale-105 rounded-md p-4 bg-primary/50">
                <div  className="text-2xl sm:text-3xl font-bold text-blue-300">500+</div>
                <div className="text-sm text-blue-200">Projects</div>
              </div>
              <div className="text-center lg:text-left solar-panel  border border-primaryLighter duration-200 ease-in hover:scale-105 rounded-md p-4 bg-primary/50">
                <div className="text-2xl sm:text-3xl font-bold text-blue-300">95%</div>
